...
>
    ...
    >
        ...
        >
            @if (auth()->user()?->hasRole('teacher'))
                @if (filament()->hasNavigation())
                    <ul class="hidden items-center gap-x-4 lg:flex">
    ...
    'filament.training.pages.teacher-detail',
    'filament.training.pages.teacher-material',
    'filament.training.pages.teacher-quiz',
])"
                                            :icon="$group->getIcon()"
                                        >
                                            {{ $groupLabel }}
