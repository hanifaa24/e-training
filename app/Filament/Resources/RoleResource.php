...
class RoleResource extends Resource implements HasShieldPermissions
{
            ...
            ->actions([
                ...
                Tables\Actions\DeleteAction::make()
                    ...
                    ->modalSubheading(function (Model $record) {
                        ...
                        return "This role is assigned to {$userCount} user(s). Deleting this role will also delete those users. Are you sure?";
                    })
                    ->modalIcon(function (Model $record) {
                        $hasUser = DB::table('model_has_roles')
                            ->where('role_id', $record->id)
                            ->where('model_type', User::class)
                            ->exists();
                    ...
                    ->action(function (Model $record) {
                        ...
                        // Hapus user yang memiliki role ini
                        ...
                        Notification::make()
                            ->title('Role and Related Users Deleted')
                            ->success()
                            ->send();
                    }),
            ])
            ->groupedBulkActions([
                DeleteBulkAction::make()
                    ...
                    ->modalSubheading(function ($records) {
                        $hasUsers = $records->filter(function ($record) {
                        ...
                        return $hasUsers
                            ? 'Some roles are assigned to users. Deleting them will also delete the related users. Are you sure?'
                    ...
                    ->modalIcon(function ($records) {
                        ...
                        return $hasUsers ? 'heroicon-o-exclamation-triangle' : 'heroicon-o-trash';
                    })
                    ->modalIconColor(function ($records) {
                        ...
                        return $hasUsers ? Color::Amber : Color::Red;
                    })
                    ->action(function ($records) {
                        ...
                        Notification::make()
                            ->title('Selected Roles and Users Deleted')
                            ->success()
                            ->send();
                    })
    ...
    {
        return null; // atau bisa dikosongkan agar tidak masuk grup manapun
    }
